...
public class ProductMappingConfig : IRegister
{
    public void Register(TypeAdapterConfig config)
    {
        ...
        .Map(dest => dest.PersonIds, src => src.PersonIds.Select(x => new PersonIdsCommand(x.Id)).ToHashSet());
        ...
        .Map(dest => dest.PersonId, src => src.PersonIds.Select(x => x.Adapt<PersonIds>()).ToHashSet()); // Map Product's PersonIds to ProductResponse's PersonIds
